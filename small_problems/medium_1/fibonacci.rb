...
---Problem---
- Input: Integer 
- Output: Integer representing the fibonacci number at the argument. 
...
1. Define a method that takes an integer argument. 
  2. Escape condition for when integer reaches less than 2. 
  3. Invoke fib method given argument int minus 1 + invocation of fib method given arg int minus 2.
4.End method.
=end
